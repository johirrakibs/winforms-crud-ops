...
namespace StudentsRecord
{
    ...
    {
        SqlConnection sqlConn = new SqlConnection(@"Data Source=DESKTOP-R1IJ2KK\SQLEXPRESS;Initial Catalog=dbStudentRecord;Integrated Security=True");
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void btnView_Click_1(object sender, EventArgs e)
        {
            ...
            using (StreamWriter writer = new StreamWriter("D:\\C# Project\\StudentsRecord\\ExportedData.csv"))
            {
